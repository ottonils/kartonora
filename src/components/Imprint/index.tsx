            ...
            <div className="w-full max-w-3xl space-y-8 md:space-y-10 text-[#151515]">
                ...
                <section aria-labelledby="person-details-heading">
                    ...
                    <ul className='text-left space-y-1 mt-4 sm:mt-5 text-sm sm:text-base leading-relaxed'> 
                        ...
                        <li>E-Mail: <a href="mailto:nora@schlossotto.de" className="text-[#A3C1AD] hover:text-[#8aa894] underline transition-colors duration-200">nora@schlossotto.de</a></li>
                    </ul>
                </section>
                ...
                <section aria-labelledby="dispute-resolution-heading" className="w-full">
                    <h4 
                        ...
                        className={`${playwriteDKLoopet.className} text-[#A3C1AD] mb-3 sm:mb-4 text-xl sm:text-[1.3rem] font-medium text-left sm:text-center`}
                    >
                        Streitschlichtung
                    </h4>
                    <article className="text-sm sm:text-base text-left sm:text-center leading-relaxed">
                        Die Europäische Kommission stellt eine Plattform zur Online-Streitbeilegung (OS) bereit, 
                        die Sie unter <a href="https://ec.europa.eu/consumers/odr" target="_blank" rel="noopener noreferrer" className="text-[#A3C1AD] hover:text-[#8aa894] underline transition-colors duration-200">https://ec.europa.eu/consumers/odr</a> finden. 
